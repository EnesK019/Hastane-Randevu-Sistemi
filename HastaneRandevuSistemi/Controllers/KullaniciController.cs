    ...
    public class KullaniciController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Kullanicilar != null ? 
                          ...
                          Problem("Entity set 'HastaneContext.Kullanicilar'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,UserSurname")] Kullanici kullanici)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,UserSurname")] Kullanici kullanici)
        {
            if (id != kullanici.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HastaneContext.Kullanicilar'  is null.");
            }
            var kullanici = await _context.Kullanicilar.FindAsync(id);
            if (kullanici != null)
            {
